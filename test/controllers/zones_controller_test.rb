...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post zones_url, params: { zone: { humidity: @zone.humidity, name: @zone.name, temperature: @zone.temperature, weather: @zone.weather } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { humidity: @zone.humidity, name: @zone.name, temperature: @zone.temperature, weather: @zone.weather } }
